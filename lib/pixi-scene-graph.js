...
var Exporter = /** @class */ (function () {
     ...
     */
    Exporter.prototype.export = function (rootNode) {
...
var Pixi = /** @class */ (function (_super) {
    ...
    Pixi.prototype.createSchema = function (scene) {
        var root = {
...
var Pixi = /** @class */ (function (_super) {
    ...
    Pixi.prototype.restoreScene = function (root, schema) {
        var tempContainerMap = new Map();
        var tempNodeMap = new Map();
        var resources = PIXI.loader.resources;
        // instantiate all
        for (var i = 0; i < schema.scene.length; i++) {
            var node = schema.scene[i];
            var object = this.restoreNodeWithResource(node, resources);
            tempContainerMap.set(node.id, object);
            tempNodeMap.set(node.id, node);
        }
        // rebuild hielarchy
        tempContainerMap.forEach(function (v, k) {
            var node = tempNodeMap.get(k);
            if (node && node.transform.parent) {
                var container = tempContainerMap.get(node.transform.parent);
                if (container) {
    ...
    Pixi.prototype.restoreNodeWithResource = function (node, resources) {
        var object;
        if (node.spine) {
