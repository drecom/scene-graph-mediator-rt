...
/* harmony import */ var _component_Layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./component/Layout */ "./src/importer/component/Layout.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var Pixi = /** @class */ (function (_super) {
    ...
    Pixi.prototype.restoreTransform = function (root, schema, nodeMap, containerMap, option) {
        ...
        containerMap.forEach(function (container, id) {
            ...
            _component_Layout__WEBPACK_IMPORTED_MODULE_1__["LayoutComponent"].fixLayout(container, node);
        });
