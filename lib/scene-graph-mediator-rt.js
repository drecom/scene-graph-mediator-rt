...
/* harmony default export */ __webpack_exports__["default"] = (Exporters);
...
var Pixi = /** @class */ (function (_super) {
    ...
    Pixi.prototype.import = function (schema, callback) {
        ...
        if (assets.size > 0) {
            assets.forEach(function (asset) { return PIXI.loader.add(asset); });
...
/* harmony default export */ __webpack_exports__["default"] = (Importers);
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Importers", function() { return importer__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var exporter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! exporter */ "./src/exporter/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Exporters", function() { return exporter__WEBPACK_IMPORTED_MODULE_1__["default"]; });
