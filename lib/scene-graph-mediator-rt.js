...
var Pixi = /** @class */ (function (_super) {
    ...
    Pixi.prototype.restoreTransform = function (root, schema, nodeMap, containerMap) {
        ...
        containerMap.forEach(function (container, id) {
            ...
            container.position.set(transform.x * coordMul.x + (parentSize.width - containerSize.width) * transform.anchor.x, transform.y * coordMul.y + (parentSize.height - containerSize.height) * transform.anchor.y);
        });
    };
    return Pixi;
